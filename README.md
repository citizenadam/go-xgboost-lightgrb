...
[![Build Status](https://travis-ci.org/citizenadam/go-xgboost-lightgrb.svg?branch=master)](https://travis-ci.org/citizenadam/go-xgboost-lightgrb)
[![GoDoc](https://godoc.org/github.com/citizenadam/go-xgboost-lightgrb?status.png)](https://godoc.org/github.com/citizenadam/go-xgboost-lightgrb)
[![Coverage Status](https://coveralls.io/repos/github/citizenadam/go-xgboost-lightgrb/badge.svg?branch=master)](https://coveralls.io/github/citizenadam/go-xgboost-lightgrb?branch=master)
[![Go Report Card](https://goreportcard.com/badge/github.com/citizenadam/go-xgboost-lightgrb)](https://goreportcard.com/report/github.com/citizenadam/go-xgboost-lightgrb)
...
```sh
go get github.com/citizenadam/go-xgboost-lightgrb
```
...
Documentation is hosted on godoc ([link](https://godoc.org/github.com/citizenadam/go-xgboost-lightgrb)). Documentation contains complex usage examples and full API reference. Some additional information about usage examples can be found in [leaves_test.go](leaves_test.go).
